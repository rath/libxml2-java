...
//			System.out.println(itemNode);
	...
	public void testJaxpNodeset() throws Exception {
		...
		DocumentBuilderFactory dbf = DocumentBuilderFactory.newInstance("org.xmlsoft.jaxp.DocumentBuilderFactoryImpl", null);
		XPathFactory factory = XPathFactory.newInstance(XPathFactory.DEFAULT_OBJECT_MODEL_URI, "org.xmlsoft.jaxp.XPathFactoryImpl", null);
